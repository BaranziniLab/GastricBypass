...
# Read the data files
edges = read_excel("spoke_plot/filtered_edges.xlsx")
nodes = read_excel("spoke_plot/filtered_nodes.xlsx")
...
ggsave(filename = "pltE.png", plot = pltE, device = "png", width = 10, height = 6, bg = "white", dpi = 800)
